@php
    $sections = getPageSections(true); // true to return as array
@endphp
...
{{--                        @endforeach--}}
                        ...
                        @foreach ($sections as $key => $section)
                            @if (!empty($section['builder']) && empty($section['hide_builder']))
                                <div class="col-md-3 searchItem">
                                    <div class="frontend-section-card">
                                        <h6>{{ __($section['name']) }}</h6>
                                        <a href="{{ route('admin.frontend.sections', $key) }}" class="btn btn--light btn-sm">
                                            <i class="las la-cog me-0"></i>
                                        </a>
                                    </div>
                                </div>
                            @endif
