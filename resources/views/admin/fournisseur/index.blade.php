                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md table-responsive">
                        <table class="table table--light style--two">
                                    ...
                                    <td>
                                        <div class="button--group">
                                            <button class="btn btn-sm btn-outline--primary editBtn cuModalBtn"
                                                    data-resource="{{ $fournisseur }}"
                                                    data-modal_title="@lang('Modifier Fournisseur')"
                                                    type="button">
                                                <i class="la la-pencil"></i>@lang('Edit')
                                            </button>

                                            <button class="btn btn-sm btn-outline--danger confirmationBtn ms-1"
                                                    data-action="{{ route('admin.supplier.destroy', $fournisseur->id) }}"
                                                    data-question="@lang('Êtes-vous sûr de vouloir supprimer ce fournisseur ?')"
                                                    type="button">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-muted text-center">{{ __($emptyMessage ?? 'Aucun fournisseur trouvé') }}</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
...
@push('breadcrumb-plugins')
    <x-search-form />
    <button class="btn btn-sm btn-outline--primary cuModalBtn" data-modal_title="@lang('Ajouter Fournisseur')" type="button">
