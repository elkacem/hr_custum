                                    ...
                                    <td>
                                        <div class="button--group">
                                            ...
                                            <button class="btn btn-sm btn-outline--danger confirmationBtn ms-1"
                                                    data-action="{{ route('admin.compte.destroy', $compte->id) }}"
                                                    data-question="@lang('Êtes-vous sûr de vouloir supprimer cette compte ?')"
                                                    type="button">
    ...
    <div class="modal fade" id="cuModal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.compte.store') }}" method="POST">
                    @csrf
...
@push('breadcrumb-plugins')
    ...
    <button class="btn btn-sm btn-outline--primary cuModalBtn"
            data-modal_title="@lang('Ajouter Compte')" type="button">
