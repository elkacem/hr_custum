...
return [
    ...
    'custom' => [
        'cert_infos_correctes' => [
            'required' => 'Veuillez confirmer que les informations sont correctes.',
        ],
        'cert_conditions' => [
            'required' => 'Veuillez confirmer que vous avez consulté les conditions.',
        ],
        'cert_age_min' => [
            'required' => 'Vous devez avoir au moins 30 ans pour continuer.',
        ],
        'cert_permis_5ans' => [
            'required' => 'Veuillez confirmer que vous détenez un permis depuis au moins 5 ans.',
        ],
        'agree' => [
        ...
        'phone' => [
            'unique' => 'Ce numéro de téléphone est déjà attribué à un fournisseur.',
        ],
    ],
