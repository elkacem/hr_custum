...
class Email extends NotifyProcess implements Notifiable{
    ...
    */
    ...
    public function attachData($data, $name, $mime = 'application/pdf')
    {
        $this->attachments[] = [
            'data' => $data,
            'name' => $name,
...
//        dd($this->getEmailFrom()['email'], $this->getEmailFrom()['name']);
//        $mail->setFrom('no-reply@aeroportalger.dz', 'AeroCar');
        ...
        foreach ($this->attachments as $attachment) {
            $mail->addStringAttachment($attachment['data'], $attachment['name'], 'base64', $attachment['mime']);
        }
